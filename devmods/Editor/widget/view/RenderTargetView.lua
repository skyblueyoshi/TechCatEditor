---@class TCE.RenderTargetView:TCE.BaseView
local RenderTargetView = class("RenderTargetView", require("BaseView"))
...
function RenderTargetView:__init(key, widget, parent, parentRoot, location)
    RenderTargetView.super.__init(self, key, widget, parent, parentRoot)
    self._rtNode = nil
...
function RenderTargetView:_onDestroy()
    --IntegratedClient.main:removeSchedule(self.tickScheduler)
    RenderTargetView.super._onDestroy(self)
end
